...
Regression(Backward Algorithm)
How to determine predecessors


logical agents
8.1-8.3 First order logic
ch 9, logical inference, modus ponence
ch 10, 10.1-10.5 knowledge systems(forward chaining & backward chaining
ch 11, 11.1-11.3 planning
